...
trainingRawData = {scans(training(holdoutPartition)).RawData}';
testingRawData = {scans(test(holdoutPartition)).RawData}';
...
save([datadir filesep 'testing' filesep 'testingData.mat'], ...
    'testingData', 'testingRawData', 'testingFeatures', 'testingLabels', ...
    'holdoutPartition', 'scanLabels', '-v7.3');

mkdir(datadir, 'training');
save([datadir filesep 'training' filesep 'trainingData.mat'], ...
    'trainingData', 'trainingRawData', 'trainingFeatures', 'trainingLabels', ...
